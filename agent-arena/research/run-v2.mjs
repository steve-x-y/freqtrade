...
function run(label,data,start,end,feeBps=80,lagBars=0,withBootstrap=false){
 const result=backtest(data.candles,{...settings,feeBps},{startTime:Date.parse(start),endTime:Date.parse(end),lagBars,liquidate:true});
